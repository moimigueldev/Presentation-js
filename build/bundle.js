...
let r;const s=()=>{for(let a,b=0;b<r.children.length;b++)a=r.children[b],a.dataset.slide?(p(a),n(a)):r.removeChild(a)};console.log("in the setup config");const t=a=>{if(a)for(const b in a)g[b]&&(typeof a[b]==typeof g[b]?g[b]=a[b]:console.error(`invalid value for ${b}`))};return a.start=function(a,b){return d(a)?void(t(b),c(a)):(console.log("hello"),!1)},Object.defineProperty(a,"__esModule",{value:!0}),a}({});
